...
public class EditProposal {
  ...
  public void setProposedName(final String proposedName) {
  ...
  public void setProposedAddress(final String proposedAddress) {
  ...
  public void setProposedHours(final String proposedHours) {
  ...
  public void setProposerUserId(final String proposerUserId) {
